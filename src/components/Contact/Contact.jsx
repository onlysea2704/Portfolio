...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
            .sendForm('service_jkrzwv9', 'template_piy794u', form.current, {
                publicKey: 'vZVtvpQqQ2ULL7ofX',
            })
            .then(
                () => {
                    alert('SUCCESS!');
                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">phamduyhai2k3@gmail.com</span>
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">0918297371</span>
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">Onlysea2704</span>
